...
class AclsSpec extends BaseSpec {
  ...
  "manage acls" should {
    ...
    "list permissions on /*/*" taggedAs (IamTag, AclsTag) in {
      cl.get[AclListing]("/acls/*/*", Marge) { (acls, response) =>
        response.status shouldEqual StatusCodes.OK
    ...
    "list permissions on /orgpath1/*" taggedAs (IamTag, AclsTag) in {
      cl.get[AclListing](s"/acls/$orgPath1/*", Marge) { (acls, response) =>
        response.status shouldEqual StatusCodes.OK
    ...
    "list permissions on /*/* with ancestors" taggedAs (IamTag, AclsTag) in {
      cl.get[AclListing]("/acls/*/*?ancestors=true", Marge) { (acls, response) =>
        response.status shouldEqual StatusCodes.OK
        acls._results
          .find(_._path == "/")
          .value
